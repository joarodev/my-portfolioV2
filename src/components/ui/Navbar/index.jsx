    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 flex justify-between h-16 items-center">
          <div id="social-buttons" className="hidden md:flex flex-1 justify-center items-center gap-4">
            <SocialMediaButtons />
          </div>
          ...
          <div className="flex md:hidden flex-1 justify-center items-center gap-4">
            <Link id="mobile-home-link" to="/" className="hover:font-bold duration-150">
              {t("navbar.home")}
            </Link>
            <Link id="mobile-projects-link" to="/projects" className="hover:font-bold duration-150">
              {t("navbar.projects")}
            </Link>
            <Link
          ...
          <div  className="hidden md:flex flex-1 justify-end">
            <div className="dropdown-hover-container">
              <button id="settings-button" className="p-2 rounded-md hover:bg-primary/20 transition">
                <Settings size={20} />
              </button>
          ...
          <div className="md:hidden flex-1 flex justify-end">
            <button id="mobile-menu-button" onClick={() => setIsMobileMenuOpen(true)}>
              <Menu size={24} />
            </button>
          </div>
        </div>
